...
/*阶乘*/
const int16_t SEVEN_MT = 5040;
const int16_t SIX_MT = 720;
const int16_t FIVE_MT = 120;
const int16_t FOUR_MT = 24;
const int16_t THREE_MT = 6;
