...
typedef struct _can1_senddata
{
	...
	int16_t motorup_out;
	int16_t pitchout_right;
	int16_t pitchout_left;
	//int16_t yaw_out;
	//int16_t pitch_out[2];
...
extern can1_senddata can1Senddata_frict;
extern can1_senddata can1Senddata_pitch;
...
void Can1_Send_Data_to_Pitch(can1_senddata *);
